...
export function updatePanel(d,_force=false){
    ...
    {const _sec=mkSection('branches',t('Story Ideas'),d.plotBranches?.length||0,()=>{
        ...
        c.querySelector('.sp-idea-header').addEventListener('click',(e)=>{if(e.target.closest('.sp-idea-paste')||e.target.closest('.sp-idea-inject'))return;c.classList.toggle('sp-card-open');resizeSectionContent()});
