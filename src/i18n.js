...
'Korean': {
    ...
    'No scene data yet':'장면 데이터 없음','Send a message or click ⟳ to generate.':'메시지를 보내거나 ⟳을 클릭하세요.',
    'No active storyline quests':'활성 스토리 퀘스트 없음','No side quests discovered':'발견된 사이드 퀘스트 없음',
    'No immediate tasks':'즉각적인 작업 없음','Not yet revealed':'아직 밝혀지지 않음',
...
'Chinese (Simplified)': {
    ...
    'No scene data yet':'暂无场景数据','Send a message or click ⟳ to generate.':'发送消息或点击 ⟳ 生成。',
    'No active storyline quests':'没有活跃的主线任务','No side quests discovered':'没有发现支线任务',
    'No immediate tasks':'没有紧急任务','Not yet revealed':'尚未揭示',
...
'Spanish': {
    ...
    'No scene data yet':'Sin datos de escena','Send a message or click ⟳ to generate.':'Envía un mensaje o haz clic en ⟳ para generar.',
    'No active storyline quests':'Sin misiones de historia activas','No side quests discovered':'Sin misiones secundarias descubiertas',
    'No immediate tasks':'Sin tareas inmediatas','Not yet revealed':'Aún no revelado',
...
'French': {
    ...
    'No scene data yet':'Aucune donnée de scène','Send a message or click ⟳ to generate.':'Envoyez un message ou cliquez sur ⟳ pour générer.',
    'No active storyline quests':'Aucune quête principale active','No side quests discovered':'Aucune quête secondaire découverte',
    'No immediate tasks':'Aucune tâche immédiate','Not yet revealed':'Pas encore révélé',
...
'German': {
    ...
    'No scene data yet':'Keine Szenendaten','Send a message or click ⟳ to generate.':'Sende eine Nachricht oder klicke ⟳ zum Generieren.',
    'No active storyline quests':'Keine aktiven Story-Quests','No side quests discovered':'Keine Nebenquests entdeckt',
    'No immediate tasks':'Keine unmittelbaren Aufgaben','Not yet revealed':'Noch nicht enthüllt',
...
'Portuguese': {
    ...
    'No scene data yet':'Sem dados de cena','Send a message or click ⟳ to generate.':'Envie uma mensagem ou clique ⟳ para gerar.',
    'No active storyline quests':'Sem missões de história ativas','No side quests discovered':'Sem missões secundárias descobertas',
    'No immediate tasks':'Sem tarefas imediatas','Not yet revealed':'Ainda não revelado',
