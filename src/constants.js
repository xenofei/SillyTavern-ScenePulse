...
export const TOUR_EXAMPLE_DATA={
    ...
    relationships:[
        {name:'Elena Vasquez',relType:'Co-worker',relPhase:'Friendly',timeTogether:'3 months',milestone:'Elena covered a shift when no one else would \u2014 first real act of trust',affection:62,affectionLabel:'Warm',trust:55,trustLabel:'Building',desire:20,desireLabel:'',stress:30,stressLabel:'Manageable',compatibility:68,compatibilityLabel:'Natural fit'},
        {name:'Marcus Chen',relType:'Customer',relPhase:'Hostile',timeTogether:'2 months (weekly visits)',milestone:'Filed a formal complaint last week about a wrong order',affection:8,affectionLabel:'Cold',trust:12,trustLabel:'Distrustful',desire:0,desireLabel:'N/A',stress:72,stressLabel:'High friction',compatibility:15,compatibilityLabel:'Oil and water'},
        {name:'Yuki Tanaka',relType:'Customer',relPhase:'Strangers',timeTogether:'Less than a minute',milestone:'Walked in during the confrontation, observing quietly',affection:0,affectionLabel:'',trust:0,trustLabel:'',desire:0,desireLabel:'',stress:10,stressLabel:'',compatibility:0,compatibilityLabel:''}
    ],
    characters:[
